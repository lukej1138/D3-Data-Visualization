...
function _10(network,d3,opacity,size,color,forceBoundary,drag,invalidation)
{
  const width = 600;
  const height = 600;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["network","d3","opacity","size","color","forceBoundary","drag","invalidation"], _10);
